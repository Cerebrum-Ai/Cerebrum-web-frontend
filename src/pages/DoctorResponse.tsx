...
import { CheckCircle, Clock, FileText, AlertCircle, ChevronLeft, Loader2, Stethoscope } from "lucide-react";
...
const DoctorResponse = () => {
  ...
  useEffect(() => {
    const fetchAnalysisAndResponse = async () => {
      ...
      try {
        // Get the most recent analysis record for this user
        ...
        // Check if there's a doctor analysis for this analysis record
    ...
    // Poll for doctor analysis every 30 seconds
    const interval = setInterval(async () => {
      ...
      try {
        ...
        console.error("Error polling for doctor analysis:", err);
      }
    }, 30000);
      ...
      <div>
        ...
        <div className="min-h-screen bg-gradient-to-b from-fuchsia-100 via-blue-50/60 to-white dark:from-[#34205e]/50 dark:via-background/60 dark:to-background pt-20 pb-10 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-700 dark:text-gray-300">Loading your analysis data...</p>
          </div>
        </div>
      </div>
    );
          ...
          <div className="max-w-2xl mx-auto px-4 pt-12">
            <Card className="w-full bg-white/90 dark:bg-card/90 backdrop-blur-lg border border-gray-200 dark:border-gray-700">
              <CardHeader className="text-center">
                ...
                <CardDescription>
                  {error || "No analysis was found. Please submit an analysis first."}
                </CardDescription>
              </CardHeader>
              ...
              <div className="mb-6">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">#{analysis.id.substring(0, 8)}...</p>
                  </div>
                </div>
                ...
                {doctorAnalysis?.doctor ? (
                  <div className="flex items-center p-3 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
                    <Avatar className="h-12 w-12 mr-4 border border-gray-200 dark:border-gray-700">
                      {doctorAnalysis.doctor.image_url ? (
                        <AvatarImage src={doctorAnalysis.doctor.image_url} />
                      ) : (
                        <AvatarFallback>
                    ...
                    <div>
                      <p className="font-medium">
                        Dr. {doctorAnalysis.doctor.first_name} {doctorAnalysis.doctor.last_name || ""}
                      </p>
                      <p className="text-sm text-[#62d5d0]">
                        {doctorAnalysis.doctor.specialization || "Medical Specialist"}
                      </p>
                    </div>
                  </div>
                ) : (
                  <p className="text-gray-500">Doctor information will be available when the analysis is reviewed</p>
                )}
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="w-full bg-white/90 dark:bg-card/90 backdrop-blur-lg border border-gray-200 dark:border-gray-700">
              ...
              {doctorAnalysis ? (
                <div className="space-y-6">
                  ...
                  <div className="flex items-center text-sm text-gray-500">
                    ...
                    <span>Response provided on {new Date(doctorAnalysis.created_at).toLocaleString()}</span>
                  </div>
                </div>
              ) : (
                <div className="py-12 flex flex-col items-center justify-center text-center">
                  ...
                  <h3 className="text-lg font-medium mb-2">Awaiting Doctor's Response</h3>
                  <p className="text-gray-500 dark:text-gray-400 max-w-md">
                    Your analysis has been sent to the doctor for review. 
                    Please check back later for the doctor's assessment.
                  </p>
            ...
            <CardFooter className="flex flex-col space-y-4">
              ...
              <p className="text-xs text-center text-gray-500 dark:text-gray-400">
                Need help? Contact our support team for assistance with your medical consultation.
              </p>
            </CardFooter>
          </Card>
        </div>
